...
public class UserCartController {
	...
	@PutMapping
	public ResponseEntity<CartData> updateCart(@RequestBody CartData cartData) throws Exception {		
		return new ResponseEntity(userCartService.updateCart(cartData), HttpStatus.ACCEPTED);
	}
